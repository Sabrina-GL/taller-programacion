defmodule LedgerTest do
  ...
  describe "Tests para Ledger.Usuario" do
    ...
    test "editar_usuario con id inválido" do
      assert {:error, "ID inválido: debe ser un número"} == Usuario.editar_usuario("asd", "userB")
